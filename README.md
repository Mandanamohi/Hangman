This Python script generates a random word from a predefined list and allows the user to input a single letter, providing feedback on whether the input is valid or not.
